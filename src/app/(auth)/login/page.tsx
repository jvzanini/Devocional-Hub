    ...
    <div className="page-bg" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          <div className="logo-icon" style={{ margin: "0 auto 18px", width: 60, height: 60, borderRadius: 16 }}>
        ...
        <div className="card" style={{ padding: 28 }}>
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            {error && (
              <div className="alert-error" style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "#dc2626" }}>
        ...
        <p style={{ textAlign: "center", fontSize: 12, color: "#a8a29e", marginTop: 24 }}>Devocional Hub — Plataforma de devocionais</p>
      </div>
    </div>
  );
}
